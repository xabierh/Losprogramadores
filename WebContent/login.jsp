<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body style="background:rgb(24, 22, 22)">
        ...
        <div class="container">
                <h1 style="text-align:center;font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;color:rgb(207, 202, 157);font-size:4em;">Login</h1>
                <form style="margin:20px;">
                        <div class="form-row">
                           
                            <div class="col" style="margin:auto;color:rgb(238, 84, 84);">
                      ...
                      <button type="submit" id="guardar" class="btn btn-primary" style="margin-bottom:20px;">Iniciar sesion</button>
                            </form>
